...
$ca.Name = "SpoCustomizationApplicationCustomizer"
$ca.Title = "Deploy CSS and JS Application Extension"
$ca.Description = "Deploy custom CSS and JS to make minor style modifications to SharePoint Online"
$ca.Update()
